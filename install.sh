...
rm -rf third_party/custom_flashinfer/3rdparty/cutlass/media/docs/build
rm -rf third_party/custom_flashinfer/build
rm -rf third_party/prometheus-cpp/3rdparty/civetweb/build
rm -rf ~/.ktransformers
