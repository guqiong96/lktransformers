...
class ArgumentParser:
    ...
    def parse_args(self):
        ...
        if model_config.architectures[0] == "Qwen3MoeForCausalLM" or model_config.architectures[0] == "Qwen2MoeForCausalLM" or model_config.architectures[0] == "Glm4MoeForCausalLM" or model_config.architectures[0] == "Qwen3NextForCausalLM":
